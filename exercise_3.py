...
from this list in it and print out this new list. Write this in one line of Python.
...
#extras 1 (list generation)
print([x for x in a if x < 5])

#extras 2 (list generation based on input)
user_number = int(input("Enter a number: "))
print([x for x in a if x < user_number])
